...
DEFINE_QNODE(ipa_core_master, SM6350_MASTER_IPA_CORE, 1, 8, SM6350_SLAVE_IPA_CORE);
...
DEFINE_QNODE(ipa_core_slave, SM6350_SLAVE_IPA_CORE, 1, 8);
...
DEFINE_QBCM(bcm_mm1, "MM1", false, &qxm_camnoc_hf0_uncomp, &qxm_camnoc_icp_uncomp, &qxm_camnoc_sf_uncomp, &qxm_camnoc_hf, &qxm_mdp0);
...
static struct qcom_icc_desc sm6350_aggre1_noc = {
...
static struct qcom_icc_desc sm6350_aggre2_noc = {
...
static struct qcom_icc_desc sm6350_clk_virt = {
...
static struct qcom_icc_desc sm6350_compute_noc = {
...
static struct qcom_icc_desc sm6350_config_noc = {
...
static struct qcom_icc_desc sm6350_dc_noc = {
	.nodes = dc_noc_nodes,
...
static struct qcom_icc_desc sm6350_gem_noc = {
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc sm6350_mmss_noc = {
...
static struct qcom_icc_desc sm6350_npu_noc = {
	.nodes = npu_noc_nodes,
