...
static const struct adc5_channels adc5_chans_pmic[ADC5_MAX_CHANNEL] = {
	...
	[ADC5_BAT_THERM_100K_PU] = ADC5_CHAN_TEMP("bat_therm_pu2", 1,
					SCALE_HW_CALIB_THERM_100K_PULLUP)
	[ADC5_BAT_THERM_30K_PU]	= ADC5_CHAN_TEMP("bat_therm_pu1", 1,
					SCALE_HW_CALIB_THERM_30K_PULLUP)
	//[ADC5_BAT_THERM_400K_PU] = ADC5_CHAN_TEMP("bat_therm_pu3", 1,
	//				SCALE_HW_CALIB_THERM_400K_PULLUP)
	[ADC5_BAT_ID_100K_PU]	= ADC5_CHAN_TEMP("bat_id", 1,
					SCALE_HW_CALIB_DEFAULT)
