...
static int gcc_debug_msm8953_probe(struct platform_device *pdev)
{
	int ret = 0; int i = 0;
...
static int gcc_debug_msm8953_remove(struct platform_device *pdev)
{
	if (!IS_ERR_OR_NULL(rootdir)) {
...
static const struct of_device_id gcc_debug_msm8953_match_table[] = {
	{ .compatible = "qcom,gcc-msm8953-debug" },
	{},
};

static struct platform_driver gcc_debug_msm8953_driver = {
	.probe = gcc_debug_msm8953_probe,
	.remove = gcc_debug_msm8953_remove,
	.driver = {
		.name = "debug-msm8953",
		.of_match_table = gcc_debug_msm8953_match_table,
		.owner = THIS_MODULE,
	},
};

module_platform_driver(gcc_debug_msm8953_driver);
