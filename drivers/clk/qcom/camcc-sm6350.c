...
#include <dt-bindings/clock/qcom,camcc-sm6350.h>
...
static struct clk_regmap *cam_cc_sm6350_clocks[] = {
...
static struct gdsc *cam_cc_sm6350_gdscs[] = {
	[BPS_GDSC] = &bps_gdsc,
...
static const struct regmap_config cam_cc_sm6350_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc cam_cc_sm6350_desc = {
	.config = &cam_cc_sm6350_regmap_config,
	.clk_hws = cam_cc_sm6350_hws,
	.num_clk_hws = ARRAY_SIZE(cam_cc_sm6350_hws),
	.clks = cam_cc_sm6350_clocks,
	.num_clks = ARRAY_SIZE(cam_cc_sm6350_clocks),
	.gdscs = cam_cc_sm6350_gdscs,
	.num_gdscs = ARRAY_SIZE(cam_cc_sm6350_gdscs),
};

static const struct of_device_id cam_cc_sm6350_match_table[] = {
	{ .compatible = "qcom,sm6350-camcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, cam_cc_sm6350_match_table);

static int cam_cc_sm6350_probe(struct platform_device *pdev)
{
	struct regmap *regmap;

	regmap = qcom_cc_map(pdev, &cam_cc_sm6350_desc);
	if (IS_ERR(regmap))
	...
	return qcom_cc_really_probe(pdev, &cam_cc_sm6350_desc, regmap);
}

static struct platform_driver cam_cc_sm6350_driver = {
	.probe = cam_cc_sm6350_probe,
	.driver = {
		.name = "sm6350-camcc",
		.of_match_table = cam_cc_sm6350_match_table,
	},
};

static int __init cam_cc_sm6350_init(void)
{
	return platform_driver_register(&cam_cc_sm6350_driver);
}
subsys_initcall(cam_cc_sm6350_init);

static void __exit cam_cc_sm6350_exit(void)
{
	platform_driver_unregister(&cam_cc_sm6350_driver);
}
module_exit(cam_cc_sm6350_exit);

MODULE_DESCRIPTION("QTI CAM_CC SM6350 Driver");
