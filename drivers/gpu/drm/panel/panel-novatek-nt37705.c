...
{
	return container_of_const(panel, struct nt37705_boe_amoled, panel);
}
...
static int nt37705_boe_amoled_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx = devm_drm_panel_alloc(dev, struct nt37705_boe_amoled, panel,
				   &nt37705_boe_amoled_panel_funcs,
