...
static int djn_hx83112b_on(struct djn_hx83112b *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0x83, 0x11, 0x2b);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0x08, 0x70);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x04, 0x38, 0x08, 0x70);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xb1,
			       0xf8, 0x27, 0x27, 0x00, 0x00, 0x0b, 0x0e, 0x0b,
			       0x0e, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0xd2, 0x2d, 0x2d);
	mipi_dsi_dcs_write_seq(dsi, 0xb2,
			       0x80, 0x02, 0x18, 0x80, 0x70, 0x00, 0x08, 0x1c,
			       0x08, 0x11, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xd1);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x00, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0xb5, 0x0a);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xdd,
			       0x00, 0x00, 0x08, 0x1c, 0x08, 0x34, 0x34, 0x88);
	mipi_dsi_dcs_write_seq(dsi, 0xb4,
			       0x65, 0x6b, 0x00, 0x00, 0xd0, 0xd4, 0x36, 0xcf,
			       0x06, 0xce, 0x00, 0xce, 0x00, 0x00, 0x00, 0x07,
			       0x00, 0x2a, 0x07, 0x01, 0x07, 0x00, 0x00, 0x2a);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xc3);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0x01, 0x67, 0x2a);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc1, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xc1,
			       0xff, 0xfb, 0xf9, 0xf6, 0xf4, 0xf1, 0xef, 0xea,
			       0xe7, 0xe5, 0xe2, 0xdf, 0xdd, 0xda, 0xd8, 0xd5,
			       0xd2, 0xcf, 0xcc, 0xc5, 0xbe, 0xb7, 0xb0, 0xa8,
			       0xa0, 0x98, 0x8e, 0x85, 0x7b, 0x72, 0x69, 0x5e,
			       0x53, 0x48, 0x3e, 0x35, 0x2b, 0x22, 0x17, 0x0d,
			       0x09, 0x07, 0x05, 0x01, 0x00, 0x26, 0xf0, 0x86,
			       0x25, 0x6e, 0xb6, 0xdd, 0xf3, 0xd8, 0xcc, 0x9b,
			       0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xc1,
			       0xff, 0xfb, 0xf9, 0xf6, 0xf4, 0xf1, 0xef, 0xea,
	...
	mipi_dsi_dcs_write_seq(dsi, 0xc1,
			       ...
			       0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0xcc, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0xd3,
			       0x81, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x04,
			       0x00, 0x01, 0x13, 0x40, 0x04, 0x09, 0x09, 0x0b,
			       0x0b, 0x32, 0x10, 0x08, 0x00, 0x08, 0x32, 0x10,
			       0x08, 0x00, 0x08, 0x32, 0x10, 0x08, 0x00, 0x08,
			       0x00, 0x00, 0x0a, 0x08, 0x7b);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xc5);
	mipi_dsi_dcs_write_seq(dsi, 0xc6, 0xf7);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xd4);
	mipi_dsi_dcs_write_seq(dsi, 0xc6, 0x6e);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xef);
	mipi_dsi_dcs_write_seq(dsi, 0xd3, 0x0c);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0xd3, 0xa1);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xd5,
			       0x18, 0x18, 0x19, 0x18, 0x18, 0x20, 0x18, 0x18,
			       0x18, 0x10, 0x10, 0x18, 0x18, 0x00, 0x00, 0x18,
			       0x18, 0x01, 0x01, 0x18, 0x18, 0x28, 0x28, 0x18,
			       0x18, 0x18, 0x18, 0x18, 0x2f, 0x2f, 0x30, 0x30,
			       0x31, 0x31, 0x35, 0x35, 0x36, 0x36, 0x37, 0x37,
			       0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
			       0xfc, 0xfc, 0x00, 0x00, 0xfc, 0xfc, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x18, 0x18, 0x19, 0x18, 0x18, 0x20, 0x19, 0x18,
			       0x18, 0x10, 0x10, 0x18, 0x18, 0x00, 0x00, 0x18,
			       0x18, 0x01, 0x01, 0x18, 0x18, 0x28, 0x28, 0x18,
			       0x18, 0x18, 0x18, 0x18, 0x2f, 0x2f, 0x30, 0x30,
			       0x31, 0x31, 0x35, 0x35, 0x36, 0x36, 0x37, 0x37,
	...
	mipi_dsi_dcs_write_seq(dsi, 0xd8,
			       ...
			       0xaa, 0xaf, 0xea, 0xaa, 0xaa, 0xaa, 0xab, 0xaf,
			       0xef, 0xaa, 0xaa, 0xaa, 0xaa, 0xaf, 0xea, 0xaa);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xd8,
			       0xaa, 0xaa, 0xab, 0xaf, 0xea, 0xaa, 0xaa, 0xaa,
			       0xae, 0xaf, 0xea, 0xaa);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xd8,
			       0xaa, 0xaa, 0xaa, 0xaf, 0xea, 0xaa, 0xaa, 0xaa,
	...
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xd8,
			       0xba, 0xaa, 0xaa, 0xaf, 0xea, 0xaa, 0xaa, 0xaa,
			       0xaa, 0xaf, 0xea, 0xaa, 0xba, 0xaa, 0xaa, 0xaf,
			       0xea, 0xaa, 0xaa, 0xaa, 0xaa, 0xaf, 0xea, 0xaa);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xe4);
	mipi_dsi_dcs_write_seq(dsi, 0xe7, 0x17, 0x69);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe7,
			       0x09, 0x09, 0x00, 0x07, 0xe8, 0x00, 0x26, 0x00,
			       0x07, 0x00, 0x00, 0xe8, 0x32, 0x00, 0xe9, 0x0a,
			       0x0a, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x12,
			       0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xe7,
			       0x02, 0x00, 0x01, 0x20, 0x01, 0x18, 0x08, 0xa8,
			       0x09);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xe7, 0x20, 0x20, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0xe7, 0x00, 0xdc, 0x11, 0x70, 0x00, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0xc9);
	mipi_dsi_dcs_write_seq(dsi, 0xe7, 0x2a, 0xce, 0x02, 0x70, 0x01, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xd1, 0x27);
...
static int djn_hx83112b_disable(struct drm_panel *panel)
{
	struct djn_hx83112b *ctx = to_djn_hx83112b(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
