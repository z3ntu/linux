...
static int starry_800p_on(struct starry_800p *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0x37, 0x09);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x43);
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0x43);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x1f);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x1f);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x35);
	mipi_dsi_dcs_write_seq(dsi, 0x09, 0x1f);
	mipi_dsi_dcs_write_seq(dsi, 0x0a, 0x15);
	mipi_dsi_dcs_write_seq(dsi, 0x0b, 0x15);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x1a, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x1b, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x1c, 0x1f);
	mipi_dsi_dcs_write_seq(dsi, 0x1d, 0x1f);
	mipi_dsi_dcs_write_seq(dsi, 0x1e, 0x35);
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0x1f);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x15);
	mipi_dsi_dcs_write_seq(dsi, 0x21, 0x15);
...
static int starry_800p_disable(struct drm_panel *panel)
{
	struct starry_800p *ctx = to_starry_800p(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
