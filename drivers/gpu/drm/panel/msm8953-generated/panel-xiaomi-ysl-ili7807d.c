...
static int auo720_on(struct auo720 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x15);
	mipi_dsi_dcs_write_seq(dsi, 0x01, 0x15);
	mipi_dsi_dcs_write_seq(dsi, 0x02, 0x15);
	mipi_dsi_dcs_write_seq(dsi, 0x03, 0x50);
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x10, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0xf7);
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x16, 0x17);
	mipi_dsi_dcs_write_seq(dsi, 0x18, 0x17);
	mipi_dsi_dcs_write_seq(dsi, 0x1e, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x17);
	mipi_dsi_dcs_write_seq(dsi, 0x22, 0x17);
...
static int auo720_disable(struct drm_panel *panel)
{
	struct auo720 *ctx = to_auo720(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
