...
static int otm1911_on(struct otm1911 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xcb,
			       0xfe, 0xf4, 0xf4, 0xf4, 0x00, 0x00, 0x00, 0x00,
			       0xf4, 0x07, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe0, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe1,
			       0xd6, 0xde, 0xfa, 0x1e, 0x40, 0x37, 0x55, 0x87,
			       0xb1, 0x55, 0x95, 0xc7, 0xf0, 0x15, 0x95, 0x41,
			       0x68, 0xdd, 0x06, 0x9a, 0x2b, 0x52, 0x72, 0x99,
			       0xaa, 0xca, 0xd3, 0x07, 0x42, 0xfa, 0x66, 0x8a,
			       0xc5, 0xef, 0xff, 0xff, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe2,
			       0xd6, 0xde, 0xfc, 0x1e, 0x40, 0x34, 0x4d, 0x7d,
			       0xa9, 0x55, 0x8c, 0xb4, 0xe1, 0x05, 0x95, 0x31,
			       0x59, 0xcc, 0xf4, 0x5a, 0x17, 0x40, 0x5f, 0x80,
			       0xaa, 0xad, 0xb8, 0xe7, 0x27, 0xea, 0x4b, 0x6d,
			       0xaa, 0xe5, 0xff, 0xff, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe3,
			       0x00, 0x26, 0x72, 0xb3, 0x00, 0xda, 0x02, 0x46,
			       0x7e, 0x54, 0x6f, 0xa2, 0xd4, 0xfe, 0x55, 0x2f,
			       0x5a, 0xd0, 0xfb, 0x5a, 0x21, 0x4a, 0x69, 0x8f,
			       0xaa, 0xc0, 0xc8, 0xf8, 0x36, 0xea, 0x5d, 0x80,
			       0xc0, 0xee, 0xff, 0xff, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe4,
			       0xa5, 0xb2, 0xd4, 0xf6, 0x00, 0x0e, 0x2f, 0x68,
			       0x91, 0x55, 0x78, 0xaa, 0xd4, 0xfb, 0x55, 0x2a,
			       0x52, 0xc7, 0xf0, 0x5a, 0x14, 0x3b, 0x5a, 0x7e,
			       0xaa, 0xa9, 0xaf, 0xdb, 0x1a, 0xea, 0x3f, 0x64,
			       0xa3, 0xe3, 0xff, 0xff, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe5,
			       0xba, 0xc4, 0xe3, 0x02, 0x40, 0x1b, 0x3d, 0x73,
			       0x9b, 0x55, 0x83, 0xb6, 0xe2, 0x08, 0x95, 0x38,
			       0x60, 0xd7, 0x00, 0x9a, 0x26, 0x4d, 0x6d, 0x91,
			       0xaa, 0xc9, 0xd7, 0x10, 0x4a, 0xfa, 0x6c, 0x8f,
			       0xc7, 0xf0, 0xff, 0xff, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe6,
			       0x52, 0x43, 0x57, 0x72, 0x55, 0x81, 0x8f, 0xae,
			       0xd0, 0x55, 0xb0, 0xd3, 0xf8, 0x1a, 0x95, 0x40,
			       0x66, 0xd8, 0xff, 0x5a, 0x21, 0x4b, 0x69, 0x90,
			       0xaa, 0xb7, 0xc3, 0xfa, 0x39, 0xea, 0x58, 0x7a,
			       0xb2, 0xe7, 0xff, 0xff, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0xd8, 0x03, 0xfc, 0x04, 0x00, 0x03, 0xff);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0xd8, 0x03, 0xc6, 0x03, 0xe3, 0x04, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xa0);
	mipi_dsi_dcs_write_seq(dsi, 0xd8, 0x04, 0x00, 0x03, 0xe4, 0x03, 0xbf);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x94, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xa0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x0f, 0x10, 0x0f, 0x14, 0x18, 0x12, 0x10, 0x0d,
			       0x0e, 0x12, 0x12, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x97, 0x8d, 0xce, 0x91, 0xdf, 0xe5, 0xb3, 0x99,
			       0x8f, 0x8a, 0x92, 0x9a);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xc0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x90, 0x89, 0x9a, 0x8d, 0x80, 0x85, 0xa3, 0x91,
			       0x8a, 0x87, 0x8c, 0x91);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x89, 0x98, 0x9a, 0x85, 0x85, 0x8e, 0x91, 0x88,
			       0x85, 0x83, 0x86, 0x89);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0xca,
			       0xab, 0xa5, 0xa1, 0x9c, 0x98, 0x94, 0x90, 0x8d,
			       0x8a, 0x87, 0x84, 0x82);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0xca,
			       0xf8, 0xff, 0x00, 0xfc, 0xff, 0xcc, 0xfa, 0xff,
			       0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x03);
...
static int otm1911_off(struct otm1911 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x19, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x34);
...
static int otm1911_enable(struct drm_panel *panel)
{
	struct otm1911 *ctx = to_otm1911(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static int otm1911_disable(struct drm_panel *panel)
{
	struct otm1911 *ctx = to_otm1911(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static const struct drm_panel_funcs otm1911_panel_funcs = {
	...
	.enable = otm1911_enable,
	.unprepare = otm1911_unprepare,
	.disable= otm1911_disable,
