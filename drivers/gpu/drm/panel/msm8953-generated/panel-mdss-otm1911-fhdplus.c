...
static int otm1911plus_on(struct otm1911plus *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x04, 0x38, 0x08, 0xe8);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0xc9, 0x8e);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0xca,
			       0xf0, 0xd9, 0xc8, 0xba, 0xaf, 0xa6, 0x9e, 0x98,
			       0x92, 0x8d, 0x88, 0x84);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0xca,
			       0xfe, 0xff, 0x66, 0xfb, 0xff, 0x33, 0xf6, 0xff,
			       0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xa0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x0f, 0x10, 0x0f, 0x11, 0x1b, 0x15, 0x10, 0x0c,
			       0x0d, 0x0f, 0x10, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x99, 0xc8, 0xc7, 0x8f, 0xdc, 0xed, 0xbf, 0x9a,
			       0x8f, 0x89, 0x93, 0x9c);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xc0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x91, 0xb0, 0xaf, 0x8a, 0xbd, 0xc9, 0xaa, 0x91,
			       0x8a, 0x86, 0x8d, 0x93);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0xd6,
			       0x88, 0x98, 0x98, 0x85, 0x9f, 0xa4, 0x95, 0x89,
			       0x85, 0x83, 0x86, 0x89);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xb2);
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x0a);
...
static int otm1911plus_disable(struct drm_panel *panel)
{
	struct otm1911plus *ctx = to_otm1911plus(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
