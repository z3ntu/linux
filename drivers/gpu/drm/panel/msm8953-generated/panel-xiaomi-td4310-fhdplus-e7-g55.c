...
static int td4310plus_e7_g55_on(struct td4310plus_e7_g55 *ctx)
{
	...
	mipi_dsi_generic_write_seq(dsi, 0xc7,
				   0x00, 0x19, 0x28, 0x3b, 0x4a, 0x55, 0x6d,
				   0x7d, 0x8a, 0x96, 0x48, 0x54, 0x62, 0x76,
				   0x7f, 0x8b, 0x99, 0xa4, 0xb2, 0x00, 0x19,
				   0x28, 0x3b, 0x4a, 0x55, 0x6d, 0x7d, 0x8a,
				   0x96, 0x48, 0x54, 0x62, 0x76, 0x7f, 0x8b,
				   0x99, 0xa4, 0xb2);
	mipi_dsi_generic_write_seq(dsi, 0xc8,
				   0x03, 0x00, 0x01, 0x03, 0xff, 0xfe, 0x00,
				   0x00, 0xfe, 0x01, 0xfd, 0xf7, 0x00, 0x00,
				   0x01, 0xff, 0xfb, 0xf2, 0x00, 0x00, 0x01,
				   0x03, 0x01, 0xec, 0x00, 0x00, 0xfe, 0x01,
				   0xfd, 0xf5, 0x00, 0x00, 0x01, 0xfe, 0xfa,
				   0xfe, 0x00, 0x00, 0x01, 0x03, 0xff, 0xfe,
				   0x00, 0x00, 0xfe, 0x01, 0xfd, 0xec, 0x00,
				   0x00, 0xfe, 0x01, 0xfb, 0xd3, 0x00);
				       ...
				       struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(connector->dev, &td4310plus_e7_g55_mode);
	if (!mode)
		return -ENOMEM;
