...
static int tianma_r63350_on(struct tianma_r63350 *ctx)
{
	...
	mipi_dsi_generic_write_seq(dsi, 0xc2,
				   0x31, 0xf7, 0x80, 0x17, 0x18, 0x00, 0x00,
				   0x08);
	mipi_dsi_generic_write_seq(dsi, 0xd3,
				   0x1b, 0x33, 0x99, 0xbb, 0xb3, 0x33, 0x33,
				   0x33, 0x11, 0x00, 0x01, 0x00, 0x00, 0xd8,
				   0xa0, 0x05, 0x3f, 0x3f, 0x33, 0x33, 0x72,
				   0x12, 0x8a, 0x57, 0x3d, 0xbc);
	mipi_dsi_generic_write_seq(dsi, 0xc7,
				   0x00, 0x12, 0x1a, 0x25, 0x33, 0x42, 0x4c,
				   0x5c, 0x42, 0x4a, 0x55, 0x5f, 0x69, 0x6f,
				   0x75, 0x00, 0x12, 0x1a, 0x25, 0x33, 0x42,
				   0x4c, 0x5c, 0x42, 0x4a, 0x55, 0x5f, 0x69,
				   0x6f, 0x75);
	mipi_dsi_generic_write_seq(dsi, 0xc8,
				   0x01, 0x00, 0xfe, 0x00, 0xfe, 0xc8, 0x00,
				   0x00, 0x02, 0x00, 0x00, 0xfc, 0x00, 0x04,
				   0xfe, 0x04, 0x0d, 0xed, 0x00);
...
static int tianma_r63350_off(struct tianma_r63350 *ctx)
{
	...
	mipi_dsi_generic_write_seq(dsi, 0xb0, 0x00);
	mipi_dsi_generic_write_seq(dsi, 0xd3,
				   0x13, 0x33, 0x99, 0xb3, 0xb3, 0x33, 0x33,
				   0x33, 0x11, 0x00, 0x01, 0x00, 0x00, 0xd8,
				   0xa0, 0x05, 0x3f, 0x3f, 0x33, 0x33, 0x72,
				   0x12, 0x8a, 0x57, 0x3d, 0xbc);
	msleep(50);
...
static int tianma_r63350_enable(struct drm_panel *panel)
{
	struct tianma_r63350 *ctx = to_tianma_r63350(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static int tianma_r63350_disable(struct drm_panel *panel)
{
	struct tianma_r63350 *ctx = to_tianma_r63350(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
				   ...
				   struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(connector->dev, &tianma_r63350_mode);
	if (!mode)
		return -ENOMEM;
...
static const struct drm_panel_funcs tianma_r63350_panel_funcs = {
	...
	.enable = tianma_r63350_enable,
	.unprepare = tianma_r63350_unprepare,
	.disable= tianma_r63350_disable,
