...
{
	return container_of_const(panel, struct mem_lg_novatek_35521, panel);
}
...
static int mem_lg_novatek_35521_on(struct mem_lg_novatek_35521 *ctx)
{
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb1, 0x68, 0x21);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb5, 0xc8);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb6, 0x10);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbb, 0x74, 0x44);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbd,
				     0x02, 0x68, 0x20, 0x20, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x6f, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf7, 0x47);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x6f, 0x17);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf4, 0x60);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd9, 0x00, 0x01, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf0,
				     0x55, 0xaa, 0x52, 0x08, 0x01);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb3, 0x1f, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb4, 0x28, 0x28);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb9, 0x35, 0x35);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xba, 0x25, 0x25);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbc, 0x93, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbd, 0xa3, 0x00);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb0,
				     0x00, 0x00, 0x00, 0x16, 0x00, 0x34, 0x00,
				     0x50, 0x00, 0x64, 0x00, 0x87, 0x00, 0xa6,
				     0x00, 0xd5);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb1,
				     0x00, 0xfb, 0x01, 0x39, 0x01, 0x69, 0x01,
				     0xb7, 0x01, 0xf5, 0x01, 0xf7, 0x02, 0x30,
				     0x02, 0x74);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb2,
				     0x02, 0x97, 0x02, 0xcd, 0x02, 0xf2, 0x03,
				     0x14, 0x03, 0x25, 0x03, 0x37, 0x03, 0x44,
				     0x03, 0x5f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb3, 0x03, 0x6f, 0x03, 0x9f);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb6,
				     ...
				     0x14, 0x03, 0x25, 0x03, 0x37, 0x03, 0x44,
				     0x03, 0x5f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb7, 0x03, 0x6f, 0x03, 0x9f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb8,
				     0x00, 0x00, 0x00, 0x0b, 0x00, 0x24, 0x00,
				     0x3c, 0x00, 0x4b, 0x00, 0x71, 0x00, 0x8b,
				     0x00, 0xbd);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb9,
				     0x00, 0xe5, 0x01, 0x27, 0x01, 0x5a, 0x01,
				     0xab, 0x01, 0xec, 0x01, 0xee, 0x02, 0x2a,
				     0x02, 0x6f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xba,
				     0x02, 0x94, 0x02, 0xcd, 0x02, 0xf6, 0x03,
				     0x1f, 0x03, 0x36, 0x03, 0x52, 0x03, 0x69,
				     0x03, 0x8f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbb, 0x03, 0x9f, 0x03, 0xff);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf0,
				     0x55, 0xaa, 0x52, 0x08, 0x03);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb0, 0x22, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb1, 0x22, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb2,
				     0x05, 0x00, 0xb0, 0x00, 0x00);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbd,
				     0x53, 0x00, 0xb0, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc0, 0x00, 0x60, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc1, 0x00, 0x00, 0x60, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc2, 0x00, 0x00, 0x34, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc3, 0x00, 0x00, 0x34, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc4, 0x60);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc5, 0xc0);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xba, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbb, 0x0a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbc, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbd,
				     0x03, 0x03, 0x00, 0x03, 0x03);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc0, 0x0b);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc1, 0x09);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc2, 0xa6);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc3, 0x05);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc4, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc5, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc6, 0x22);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc7, 0x03);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc8, 0x07, 0x20);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc9, 0x03, 0x20);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xca, 0x01, 0x60);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcb, 0x01, 0x60);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcc, 0x00, 0x00, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcd, 0x00, 0x00, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xce, 0x00, 0x00, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcf, 0x00, 0x00, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd0, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd1,
				     0x00, 0x05, 0x01, 0x07, 0x10);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd2,
				     0x10, 0x05, 0x05, 0x03, 0x10);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd3,
				     0x20, 0x00, 0x43, 0x07, 0x10);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd4,
				     0x30, 0x00, 0x43, 0x07, 0x10);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xed, 0x33);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf0,
				     0x55, 0xaa, 0x52, 0x08, 0x06);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb0, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb1, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb2, 0x2d, 0x2e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb3, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb4, 0x29, 0x2a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb5, 0x13, 0x11);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb6, 0x19, 0x17);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb7, 0x01, 0x03);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb8, 0x34, 0x31);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb9, 0x31, 0x31);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xba, 0x31, 0x31);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbb, 0x31, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbc, 0x02, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbd, 0x16, 0x18);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbe, 0x10, 0x12);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbf, 0x2a, 0x29);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc0, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc1, 0x2e, 0x2d);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc2, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc3, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc4, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc5, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc6, 0x2e, 0x2d);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc7, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc8, 0x29, 0x2a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc9, 0x16, 0x18);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xca, 0x10, 0x12);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcb, 0x02, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcc, 0x34, 0x31);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcd, 0x31, 0x31);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xce, 0x31, 0x31);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcf, 0x31, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd0, 0x01, 0x03);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd1, 0x13, 0x11);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd2, 0x19, 0x17);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd3, 0x2a, 0x29);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd4, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd5, 0x2d, 0x2e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd6, 0x34, 0x34);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd7, 0x34, 0x34);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf0,
				     0x55, 0xaa, 0x52, 0x08, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd1,
				     0x00, 0x07, 0x0b, 0x11, 0x18, 0x20, 0x27,
				     0x27, 0x25, 0x21, 0x1c, 0x14, 0x0c, 0x06,
				     0x02, 0x00);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd7,
				     0x30, 0x30, 0x30, 0x28, 0x00, 0x00, 0x00,
				     0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd8,
				     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				     0x00, 0x00, 0x28, 0x30, 0x30);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd3, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd6, 0x44, 0x44);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd9, 0x00, 0x01);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xe7,
				     0xff, 0xfa, 0xf8, 0xf5, 0xee, 0xe1, 0xd5,
				     0xcd, 0xb9, 0xb4);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf5,
				     0x02, 0x1d, 0x1b, 0x1b, 0x14, 0x14, 0x12,
				     0x0f, 0x12, 0x20);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x6f, 0x10);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf5, 0x70);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xe8,
				     0xff, 0xfa, 0xf5, 0xeb, 0xe1, 0xc8, 0xaa,
				     0x96, 0x73, 0x66);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x6f, 0x0c);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xf5, 0x0c);
...
{
	return drm_connector_helper_get_modes_fixed(connector, &mem_lg_novatek_35521_mode);
}
...
static int mem_lg_novatek_35521_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx = devm_drm_panel_alloc(dev, struct mem_lg_novatek_35521, panel,
				   &mem_lg_novatek_35521_panel_funcs,
