...
static int lgd_lg4237_on(struct lgd_lg4237 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, MIPI_DCS_SET_ADDRESS_MODE, 0x40);
	mipi_dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_CONTROL_DISPLAY, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0xac);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0x08, 0x80, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x5c, 0x24);
	mipi_dsi_dcs_write_seq(dsi, MIPI_DCS_SET_CABC_MIN_BRIGHTNESS, 0x0b);
	mipi_dsi_dcs_write_seq(dsi, 0x5f,
			       0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
			       0x80, 0x80, 0x80, 0x80, 0x8d, 0x8d, 0x8d, 0x8d,
	...
	mipi_dsi_dcs_write_seq(dsi, 0xe1,
			       0x32, 0x3c, 0x46, 0x48, 0x4e, 0x46, 0x40, 0x30,
			       0x00, 0xfb, 0xf1, 0xee, 0xe2, 0xf6, 0x08, 0x40);
