...
static const struct msm_pingroup lagoon_groups[] = {
	...
	[1] = PINGROUP(1, ibi_i3c, qup00, cri_trng, _, _, _, _, _, _,
		       0, -1),
	[2] = PINGROUP(2, qup00, cci_i2c, cri_trng, qdss_cti, _, _, _, _,
		       _, 0, -1),
	[3] = PINGROUP(3, qup00, cci_i2c, sp_cmu, dbg_out, qdss_cti, _, _,
		       _, _, 0x9C014, 1),
	[4] = PINGROUP(4, qup14, qup14, sdc1_tb, _, _, _, _, _, _,
		       0x9C008, 3),
	[5] = PINGROUP(5, qup14, qup14, sdc2_tb, _, _, _, _, _, _, 0, -1),
	[6] = PINGROUP(6, mdp_vsync, qdss_cti, _, _, _, _, _, _, _,
		       0, -1),
	[7] = PINGROUP(7, qdss_cti, _, _, _, _, _, _, _, _, 0x9C014, 2),
	[8] = PINGROUP(8, gp_pdm1, qdss_gpio, _, _, _, _, _, _, _,
		       0x9C014, 3),
	[9] = PINGROUP(9, qdss_gpio, _, _, _, _, _, _, _, _,
		       0x9C014, 4),
	[10] = PINGROUP(10, _, _, _, _, _, _, _, _, _, 0, -1),
	[11] = PINGROUP(11, _, _, _, _, _, _, _, _, _, 0x9C008, 4),
	...
	[14] = PINGROUP(14, qup10, pll_reset, _, _, _, _, _, _, _,
			0, -1),
	[15] = PINGROUP(15, qup10, _, _, _, _, _, _, _, _, 0, -1),
	[16] = PINGROUP(16, qup10, _, _, _, _, _, _, _, _, 0x9C008, 7),
	...
	[26] = PINGROUP(26, qup13_f1, qup13_f2, _, _, _, _, _, _, _,
			0, -1),
	[27] = PINGROUP(27, qup11, qup11, mdp_vsync, pll_bist, _, qdss_gpio14,
			_, _, _, 0x9C00C, 0),
	[28] = PINGROUP(28, qup11, qup11, mdp_vsync, _, qdss_gpio15, _, _,
			_, _, 0x9C00C, 1),
	[29] = PINGROUP(29, cam_mclk0, _, _, _, _, _, _, _, _, 0, -1),
	[30] = PINGROUP(30, cam_mclk1, _, _, _, _, _, _, _, _, 0, -1),
	[31] = PINGROUP(31, cam_mclk2, _, _, _, _, _, _, _, _, 0, -1),
	[32] = PINGROUP(32, cam_mclk3, _, _, _, _, _, _, _, _, 0, -1),
	[33] = PINGROUP(33, cam_mclk4, _, _, _, _, _, _, _, _, 0, -1),
	[34] = PINGROUP(34, cci_timer0, _, phase_flag3, qdss_gpio12, _, _,
			_, _, _, 0x9C014, 5),
	[35] = PINGROUP(35, cci_timer1, cci_async, _, phase_flag4,
			qdss_gpio13, _, _, _, _, 0x9C014, 6),
	[36] = PINGROUP(36, cci_timer2, cci_async, _, phase_flag5,
			qdss_gpio14, _, _, _, _, 0x9C014, 7),
	[37] = PINGROUP(37, cci_timer3, gp_pdm0, _, phase_flag6, qdss_gpio15,
			_, _, _, _, 0x9C014, 8),
	[38] = PINGROUP(38, cci_timer4, _, phase_flag7, qdss_gpio2, _, _,
			_, _, _, 0x9C014, 9),
	[39] = PINGROUP(39, cci_i2c, _, phase_flag8, qdss_gpio0, _, _, _,
			_, _, 0, -1),
	[40] = PINGROUP(40, cci_i2c, _, phase_flag9, qdss_gpio1, _, _, _,
			_, _, 0, -1),
	[41] = PINGROUP(41, cci_i2c, _, phase_flag10, qdss_gpio2, _, _, _,
			_, _, 0, -1),
	[42] = PINGROUP(42, cci_i2c, _, phase_flag11, qdss_gpio3, _, _, _,
			_, _, 0, -1),
	[43] = PINGROUP(43, cci_i2c, _, phase_flag12, qdss_gpio4, _, _, _,
			_, _, 0, -1),
	[44] = PINGROUP(44, cci_i2c, _, phase_flag13, qdss_gpio5, _, _, _,
			_, _, 0, -1),
	[45] = PINGROUP(45, qup02, _, phase_flag14, qdss_gpio6, _, _, _,
			_, _, 0, -1),
	[46] = PINGROUP(46, qup02, _, phase_flag15, qdss_gpio7, _, _, _,
			_, _, 0, -1),
	[47] = PINGROUP(47, mdp_vsync0, _, phase_flag16, qdss_gpio3, _, _,
			_, _, _, 0, -1),
	[48] = PINGROUP(48, cci_async, mdp_vsync1, gcc_gp1, _, phase_flag17,
			qdss_gpio8, qup02, _, _, 0x9C014, 10),
	[49] = PINGROUP(49, vfr_1, _, phase_flag18, qdss_gpio9, _, _, _,
			_, _, 0, -1),
	[50] = PINGROUP(50, _, phase_flag19, qdss_gpio10, _, _, _, _, _,
			_, 0x9C00C, 2),
	[51] = PINGROUP(51, _, phase_flag20, qdss_gpio11, _, _, _, _, _,
			_, 0x9C00C, 3),
	[52] = PINGROUP(52, cci_async, gp_pdm1, _, phase_flag21, qdss_gpio12,
			_, _, _, _, 0x9C00C, 4),
	[53] = PINGROUP(53, cci_async, _, phase_flag22, qdss_gpio13, _, _,
			_, _, _, 0x9C00C, 5),
	[54] = PINGROUP(54, _, _, _, _, _, _, _, _, _, 0x9C00C, 6),
	[55] = PINGROUP(55, _, _, _, _, _, _, _, _, _, 0x9C00C, 7),
	[56] = PINGROUP(56, qup02, mdp_vsync2, _, phase_flag23, qdss_gpio10,
			_, _, _, _, 0, -1),
	[57] = PINGROUP(57, qup02, mdp_vsync3, gp_pdm2, _, phase_flag24,
			qdss_gpio11, _, _, _, 0x9C014, 11),
	[58] = PINGROUP(58, gcc_gp1, _, _, _, _, _, _, _, _,
			0x9C000, 1),
	[59] = PINGROUP(59, _, _, _, _, _, _, _, _, _, 0x9C014, 12),
	[60] = PINGROUP(60, audio_ref, lpass_ext, mi2s_2, _, phase_flag25, _,
			_, _, _, 0x9C000, 2),
	[61] = PINGROUP(61, qup01, tgu_ch0, _, phase_flag26, qdss_cti, _, _,
			_, _, 0x9C000, 3),
	[62] = PINGROUP(62, qup01, tgu_ch1, _, phase_flag27, qdss_cti, _, _,
			_, _, 0x9C000, 4),
	[63] = PINGROUP(63, qup01, tgu_ch2, _, phase_flag28, qdss_gpio, _,
			_, _, _, 0, -1),
	[64] = PINGROUP(64, qup01, tgu_ch3, _, phase_flag29, qdss_gpio, _,
			_, _, _, 0x9C000, 5),
	[65] = PINGROUP(65, mss_lte, _, qdss_gpio0, _, _, _, _, _, _,
			0, -1),
	[66] = PINGROUP(66, mss_lte, _, qdss_gpio1, _, _, _, _, _, _,
			0x9C000, 6),
	[67] = PINGROUP(67, btfm_slimbus, mi2s_1, _, phase_flag30, _, _, _,
			_, _, 0x9C000, 7),
	[68] = PINGROUP(68, btfm_slimbus, mi2s_1, gp_pdm0, _, phase_flag31,
			_, _, _, _, 0, -1),
	[69] = PINGROUP(69, _, _, _, _, _, _, _, _, _, 0x9C00C, 8),
	[70] = PINGROUP(70, _, _, _, _, _, _, _, _, _, 0, -1),
	[71] = PINGROUP(71, _, _, _, _, _, _, _, _, _, 0, -1),
	[72] = PINGROUP(72, mi2s_2, _, _, _, _, _, _, _, _, 0, -1),
	[73] = PINGROUP(73, mi2s_2, _, _, _, _, _, _, _, _, 0x9C000, 8),
	[74] = PINGROUP(74, mi2s_2, _, _, _, _, _, _, _, _, 0, -1),
	[75] = PINGROUP(75, uim2_data, _, _, _, _, _, _, _, _, 0, -1),
	[76] = PINGROUP(76, uim2_clk, _, _, _, _, _, _, _, _, 0, -1),
	[77] = PINGROUP(77, uim2_reset, _, _, _, _, _, _, _, _, 0, -1),
	[78] = PINGROUP(78, uim2_present, _, _, _, _, _, _, _, _,
			0x9C00C, 9),
	[79] = PINGROUP(79, uim1_data, _, _, _, _, _, _, _, _, 0, -1),
	[80] = PINGROUP(80, uim1_clk, _, _, _, _, _, _, _, _, 0, -1),
	[81] = PINGROUP(81, uim1_reset, _, _, _, _, _, _, _, _, 0, -1),
	...
	[85] = PINGROUP(85, sd_write, _, atest_usb11, _, _, _, _, _, _,
			0x9C00C, 13),
	[86] = PINGROUP(86, btfm_slimbus, mi2s_1, _, qdss_cti, atest_usb12,
			ddr_pxi0, _, _, _, 0, -1),
	[87] = PINGROUP(87, btfm_slimbus, mi2s_1, adsp_ext, _, qdss_cti,
			atest_usb13, ddr_pxi1, _, _, 0x9C000, 9),
	[88] = PINGROUP(88, mi2s_0, _, qdss_gpio4, _, atest_usb2, ddr_pxi2,
			tsense_pwm1, tsense_pwm2, _, 0x9C000, 10),
	[89] = PINGROUP(89, mi2s_0, agera_pll, _, qdss_gpio5, _,
			vsense_trigger, atest_usb20, ddr_pxi3, _, 0x9C000, 11),
	[90] = PINGROUP(90, mi2s_0, jitter_bist, _, qdss_gpio6, _,
			wlan1_adc0, atest_usb21, ddr_pxi0, _, 0x9C000, 12),
	[91] = PINGROUP(91, mi2s_0, _, qdss_gpio7, _, wlan2_adc0,
			atest_usb22, ddr_pxi1, _, _, 0x9C000, 13),
	[92] = PINGROUP(92, _, qdss_gpio8, atest_tsens, wlan1_adc1,
			atest_usb23, ddr_pxi2, _, _, _, 0x9C000, 14),
	[93] = PINGROUP(93, mclk, lpass_ext, _, qdss_gpio9, atest_tsens2,
			wlan2_adc1, ddr_pxi3, _, _, 0x9C000, 15),
	[94] = PINGROUP(94, _, _, _, _, _, _, _, _, _, 0x9C00C, 14),
	[95] = PINGROUP(95, ldo_en, _, atest_char, _, _, _, _, _, _,
			0x9C00C, 15),
	[96] = PINGROUP(96, ldo_update, _, atest_char0, _, _, _, _, _,
			_, 0x9C010, 0),
	...
	[99] = PINGROUP(99, _, atest_char3, _, _, _, _, _, _, _,
			0x9C010, 3),
	[100] = PINGROUP(100, _, _, _, _, _, _, _, _, _, 0x9C010, 4),
	[101] = PINGROUP(101, nav_gpio, nav_pps, nav_pps, gps_tx, _, _, _,
			 _, _, 0, -1),
	[102] = PINGROUP(102, nav_gpio, nav_pps, nav_pps, gps_tx, _, _, _,
			 _, _, 0, -1),
	...
	[106] = PINGROUP(106, qlink1_wmss, _, _, _, _, _, _, _, _,
			 0, -1),
	[107] = PINGROUP(107, qlink1_request, gps_tx, _, _, _, _, _, _,
			 _, 0x9C010, 6),
	[108] = PINGROUP(108, qlink1_enable, gps_tx, _, _, _, _, _, _,
			 _, 0, -1),
	...
	[117] = PINGROUP(117, rffe4_data, _, _, _, _, _, _, _, _,
			 0, -1),
	[118] = PINGROUP(118, rffe4_clk, _, pa_indicator, dp_hot, _, _, _,
			 _, _, 0x9C010, 11),
	[119] = PINGROUP(119, _, _, _, _, _, _, _, _, _, 0, -1),
	[120] = PINGROUP(120, _, _, _, _, _, _, _, _, _, 0, -1),
	[121] = PINGROUP(121, _, _, _, _, _, _, _, _, _, 0, -1),
	[122] = PINGROUP(122, pcie0_clk, _, _, _, _, _, _, _, _,
			 0x9C014, 13),
	[123] = PINGROUP(123, _, _, _, _, _, _, _, _, _, 0x9C014, 14),
	[124] = PINGROUP(124, usb_phy, _, _, _, _, _, _, _, _,
			 0x9C010, 12),
	[125] = PINGROUP(125, _, _, _, _, _, _, _, _, _, 0x9C010, 13),
	[126] = PINGROUP(126, _, _, _, _, _, _, _, _, _, 0, -1),
	[127] = PINGROUP(127, _, _, _, _, _, _, _, _, _, 0, -1),
	[128] = PINGROUP(128, _, _, _, _, _, _, _, _, _, 0x9C004, 0),
	[129] = PINGROUP(129, _, _, _, _, _, _, _, _, _, 0x9C004, 1),
	[130] = PINGROUP(130, _, _, _, _, _, _, _, _, _, 0, -1),
	[131] = PINGROUP(131, _, _, _, _, _, _, _, _, _, 0x9C004, 2),
	[132] = PINGROUP(132, _, _, _, _, _, _, _, _, _, 0, -1),
	[133] = PINGROUP(133, _, _, _, _, _, _, _, _, _, 0x9C004, 3),
	[134] = PINGROUP(134, _, _, _, _, _, _, _, _, _, 0x9C004, 4),
	[135] = PINGROUP(135, _, _, _, _, _, _, _, _, _, 0, -1),
	[136] = PINGROUP(136, _, _, _, _, _, _, _, _, _, 0x9C004, 5),
	[137] = PINGROUP(137, _, _, _, _, _, _, _, _, _, 0x9C004, 6),
	[138] = PINGROUP(138, _, _, _, _, _, _, _, _, _, 0x9C004, 7),
	[139] = PINGROUP(139, _, _, _, _, _, _, _, _, _, 0x9C004, 8),
	[140] = PINGROUP(140, _, _, _, _, _, _, _, _, _, 0x9C004, 9),
	[141] = PINGROUP(141, _, _, _, _, _, _, _, _, _, 0, -1),
	[142] = PINGROUP(142, _, _, _, _, _, _, _, _, _, 0x9C004, 10),
	[143] = PINGROUP(143, _, _, _, _, _, _, _, _, _, 0, -1),
	[144] = PINGROUP(144, _, _, _, _, _, _, _, _, _, 0x9C004, 11),
	[145] = PINGROUP(145, _, _, _, _, _, _, _, _, _, 0, -1),
	[146] = PINGROUP(146, _, _, _, _, _, _, _, _, _, 0, -1),
	[147] = PINGROUP(147, _, _, _, _, _, _, _, _, _, 0x9C004, 12),
	[148] = PINGROUP(148, _, _, _, _, _, _, _, _, _, 0, -1),
	[149] = PINGROUP(149, _, _, _, _, _, _, _, _, _, 0, -1),
	[150] = PINGROUP(150, _, _, _, _, _, _, _, _, _, 0, -1),
	[151] = PINGROUP(151, _, _, _, _, _, _, _, _, _, 0, -1),
	[152] = PINGROUP(152, _, _, _, _, _, _, _, _, _, 0, -1),
	[153] = PINGROUP(153, _, _, _, _, _, _, _, _, _, 0x9C004, 13),
	[154] = PINGROUP(154, _, _, _, _, _, _, _, _, _, 0, -1),
	[155] = PINGROUP(155, _, _, _, _, _, _, _, _, _, 0x9C004, 14),
