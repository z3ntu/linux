...
#define Q6AFE_LPASS_CLK_ID_QUI_MI2S_IBIT			0x10B // FP4: set to 3072000
...
#define Q6AFE_LPASS_CLK_ID_TX_CORE_MCLK				0x30c // FP4: set to 19200000
#define Q6AFE_LPASS_CLK_ID_TX_CORE_NPL_MCLK			0x30d // FP4: set to 19200000
