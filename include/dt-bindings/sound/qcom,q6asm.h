...
#define MSM_FRONTEND_DAI_CS_VOICE 16
#define MSM_FRONTEND_DAI_VOICE2 17
#define MSM_FRONTEND_DAI_VOIP 18
#define MSM_FRONTEND_DAI_VOICE_STUB 19
#define MSM_FRONTEND_DAI_VOLTE 20
#define MSM_FRONTEND_DAI_DTMF_RX 21
