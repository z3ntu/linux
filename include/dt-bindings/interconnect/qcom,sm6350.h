...
#define MASTER_QUP_CORE_0		4
#define MASTER_QUP_CORE_1		5
#define MASTER_LLCC			6
#define SLAVE_CAMNOC_UNCOMP		7
#define SLAVE_IPA_CORE			8
#define SLAVE_QUP_CORE_0		9
#define SLAVE_QUP_CORE_1		10
#define SLAVE_EBI_CH0			11
